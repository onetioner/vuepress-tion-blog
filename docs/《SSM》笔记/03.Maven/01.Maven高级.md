---
title: Maven高级
date: 2025-01-02 10:00:13
permalink: /pages/d81c5c/
categories:
  - 《SSM》笔记
  - Maven
tags:
...
![1630768703430](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630768703430.png)
...
![1630768869208](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630768869208.png)
...
![1630769969416](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630769969416.png)
...
![1630771178137](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630771178137.png)

##### 步骤2:项目中创建domain包

在`maven_03_pojo`项目中创建`com.itheima.domain`包，并将`maven_02_ssm`中Book类拷贝到该包中

![1630771371487](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630771371487.png)

##### 步骤3:删除原项目中的domain包

删除后，`maven_02_ssm`项目中用到`Book`的类中都会有红色提示，如下:

![1630771505703](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630771505703.png)
...
![1630771987325](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630771987325.png)
...
![1630773180969](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630773180969.png)

安装成功后，在对应的路径下就看到安装好的jar包

![1630773262441](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630773262441.png)
...
![1630773580067](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630773580067.png)

##### 步骤2:项目中创建dao包

在`maven_04_dao`项目中创建`com.itheima.dao`包，并将`maven_02_ssm`中BookDao类拷贝到该包中

![1630773695062](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630773695062.png)

在`maven_04_dao`中会有如下几个问题需要解决下:

![1630773958756](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630773958756.png)
...
![1630774696344](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630774696344.png)

再次对`maven_02_ssm`项目进行编译，又会报错，如下:

![1630774780211](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630774780211.png)
...
![1630774917743](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630774917743.png)

安装成功后，在对应的路径下就看到了安装好对应的jar包

![1630774946856](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630774946856.png)
...
![](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630818930387.png)
...
![1630819455928](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630819455928.png)
...
![1630819768305](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630819768305.png)

在Dependencies中移除自己所添加`maven_03_pojo`依赖后，打开BookServiceImpl的类，你会发现Book类依然存在，可以被正常使用

![1630819826163](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630819826163.png)

这个特性其实就是我们要讲解的==依赖传递==。

依赖是具有传递性的:

![1630853726532](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630853726532.png)
...
![1630820964663](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630820964663.png)
...
![1630853443920](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630853443920.png)

如果想更全面的查看Maven中各个坐标的依赖关系，可以点击Maven面板中的`show Dependencies`

![1630853519736](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630853519736.png)
...
![1630854436435](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630854436435.png)
...
![1630854923484](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630854923484.png)
...
![1630858596147](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630858596147.png)
...
![1630859532119](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630859532119.png)
...
![1630859797123](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630859797123.png)
...
![1630860344968](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630860344968.png)
...
![1630862406709](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630862406709.png)

这样我们就可以解决刚才提到的第一个问题，将子项目中的公共jar包抽取到父工程中进行统一添加依赖，这样做的可以简化配置，并且当父工程中所依赖的jar包版本发生变化，所有子项目中对应的jar包版本也会跟着更新。

![1630943390187](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630943390187.png)

#### 步骤4:优化子项目依赖版本问题

如果把所有用到的jar包都管理在父项目的pom.xml，看上去更简单些，但是这样就会导致有很多项目引入了过多自己不需要的jar包。如上面看到的这张图:

![](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630860344968.png)
...
![1630944335419](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630944335419.png)
...
![1630946592924](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630946592924.png)

##### 步骤2:创建子项目

该项目可以被聚合工程管理，同时会继承父工程。

![1630947082716](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630947082716.png)
...
![1630947403475](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630947403475.png)
...
![1630947749661](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630947749661.png)
...
![1630977419627](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630977419627.png)
...
![1630977885030](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630977885030.png)
...
![1630948929828](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630948929828.png)
...
![1630981519370](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630981519370.png)

具体如何查看这些属性:

在cmd命令行中输入`mvn help:system`

![1630981585748](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630981585748.png)
...
![1630982018031](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630982018031.png)

这里面有两个单词，SNAPSHOT和RELEASE，它们所代表的含义是什么呢?

我们打开Maven仓库地址`https://mvnrepository.com/`

![1630983148662](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630983148662.png)
...
![1630983617755](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630983617755.png)
...
![1630983967960](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630983967960.png)

查看到的结果为:

![](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630977885030.png)
...
![](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630977885031.png)

虽然已经能够实现不同环境的切换，但是每次切换都是需要手动修改，如何来实现在不改变代码的前提下完成环境的切换呢?

#### 步骤5:命令行实现环境切换

![1630984476202](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630984476202.png)

#### 步骤6:执行安装并查看env_test环境是否生效

查看到的结果为`jdbc:mysql://127.3.3.3:3306/ssm_db`

![](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630977885032.png)
...
![1630985300814](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630985300814.png)
...
![1630985411766](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630985411766.png)
...
![1630986926124](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630986926124.png)
...
![1630987192620](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630987192620.png)
...
![1630988572349](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630988572349.png)

#### 步骤2:启动Nexus

![1630988673245](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630988673245.png)
...
![1630988939301](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630988939301.png)
...
![1630988857125](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630988857125.png)

#### 步骤4:首次登录重置密码

![1630988983159](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630988983159.png)

输入用户名和密码进行登录，登录成功后，出现如下页面

![1630989052183](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630989052183.png)

点击下一步，需要重新输入新密码，为了和后面的保持一致，密码修改为`admin`

![1630989094756](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630989094756.png)

设置是否运行匿名访问

![1630989122737](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630989122737.png)

点击完成

![1630989136097](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630989136097.png)
...
![1630989320979](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630989320979.png)
...
![1630990244010](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630990244010.png)
...
![1630990538229](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630990538229.png)

上面所说的这些内容，我们需要在本地Maven的配置文件`settings.xml`中进行配置。

#### 步骤1:私服上配置仓库

![1630991211000](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630991211000.png)
...
![1630991535107](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630991535107.png)
...
![1630992305191](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630992305191.png)
...
![1630992513299](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630992513299.png)

现在发布是在itheima-snapshot仓库中，如果想发布到itheima-release仓库中就需要将项目pom.xml中的version修改成RELEASE即可。

如果想删除已经上传的资源，可以在界面上进行删除操作:

![1630992952378](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630992952378.png)

如果私服中没有对应的jar，会去中央仓库下载，速度很慢。可以配置让私服去阿里云中下载依赖。

![1630993028454](https://raw.githubusercontent.com/onetioner/img/main/PicGo/1630993028454.png)
