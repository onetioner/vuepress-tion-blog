---
title: Linux系统软件安装
date: 2023-02-14 20:14:52
permalink: /pages/eb7520/
categories:
  - 《Linux》笔记
tags:
  - 
...
1. 配置yum仓库
   ...
   ![image-20221012182514865](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221652545.png)
...
2. 使用yum安装MySQL
   ...
   ![image-20221012182555420](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221652170.png)
...
4. 检查MySQL的运行状态
   ...
   ![image-20221012182716598](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221652836.png)
...
1. 获取MySQL的初始密码
   ...
   ![image-20221012182744115](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221652217.png)
...
2. 登陆MySQL数据库系统
   ...
   ![image-20221012182805966](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221652231.png)
...
7. 检查端口
   ...
   ![image-20221012183746802](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653633.png)
...
7. 检查端口
   ...
   ![image-20221012192303607](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653171.png)
...
1. 下载apt仓库文件
   ...
   ![image-20221016094103315](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653837.png)
...
2. 配置apt仓库
   ...
   ![image-20221016094142343](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653000.png)
   ...
   ![image-20221016094254397](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653757.png)

   最后选择：`ok`

   ![image-20221016094306917](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653933.png)
...
4. 检查是否成功配置MySQL5.7的仓库
   ...
   ![image-20221016094546943](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653381.png)
...
5. 安装MySQL5.7
   ...
   ![image-20221016094941439](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653636.png)

   再次输入root密码确认

   ![image-20221016094954505](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221653287.png)
...
6. 启动MySQL
   ...
   ![image-20221016095259172](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654286.png)
...
7. 对MySQL进行初始化
   ...
   1. 输入密码：
      ...
      ![image-20221016095458755](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654319.png)

   2. 是否开启密码验证插件，如果需要增强密码安全性，输入`y`并回车，不需要直接回车（课程中选择直接回车）

      ![image-20221016095537716](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654807.png)

   3. 是否更改root密码，需要输入`y`回车，不需要直接回车（课程不更改）

      ![image-20221016095621386](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654162.png)

   4. 是否移除匿名用户，移除输入`y`回车，不移除直接回车（课程选择移除）

      ![image-20221016101232827](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654099.png)

   5. 是否进制root用户远程登录，禁止输入`y`回车，不禁止直接回车（课程选择不禁止）

      ![image-20221016101324577](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654151.png)

   6. 是否移除自带的测试数据库，移除输入`y`回车，不移除直接回车（课程选择不移除）

      ![image-20221016101404392](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654348.png)

   7. 是否刷新权限，刷新输入`y`回车，不刷新直接回车（课程选择刷新）

      ![image-20221016101442459](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654213.png)
...
8. 登陆MySQL
   ...
   ![image-20221016101524498](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654646.png)
...
8. 对MySQL进行初始化
   ...
   1. 输入密码：
      ...
      ![image-20221016095458755](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221654031.png)

   2. 是否开启密码验证插件，如果需要增强密码安全性，输入`y`并回车，不需要直接回车（课程中选择直接回车）

      ![image-20221016095537716](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655721.png)

   3. 是否更改root密码，需要输入`y`回车，不需要直接回车（课程不更改）

      ![image-20221016095621386](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655108.png)

   4. 是否移除匿名用户，移除输入`y`回车，不移除直接回车（课程选择移除）

      ![image-20221016101232827](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655915.png)

   5. 是否进制root用户远程登录，禁止输入`y`回车，不禁止直接回车（课程选择不禁止）

      ![image-20221016101324577](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655825.png)

   6. 是否移除自带的测试数据库，移除输入`y`回车，不移除直接回车（课程选择不移除）

      ![image-20221016101404392](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655077.png)

   7. 是否刷新权限，刷新输入`y`回车，不刷新直接回车（课程选择刷新）

      ![image-20221016101442459](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655242.png)
...
9. 重新登陆MySQL（用更改后的密码）
   ...
   ![image-20221016110414182](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655181.png)
...
1. 下载JDK软件
   ...
   <img src="https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655084.png" alt="image-20221017163411651" style="zoom: 67%;" />

   下载`jdk-8u351-linux-x64.tar.gz`

   ![image-20221017163440491](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655470.png)

   ==在弹出的页面中输入Oracle的账户密码即可下载（如无账户，请自行注册，注册是免费的）==

2. 登陆Linux系统，切换到root用户

   ![](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655180.png)

3. 通过FinalShell，上传下载好的JDK安装包

   ![image-20221017163706026](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221655279.png)
...
9. tomcat启动在8080端口，可以检查是否正常启动成功
   ...
   ![image-20221017223814737](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656679.png)
...
10. 打开浏览器，输入：
    ...
    ![image-20221017223915498](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656901.png)
...
![image-20221018143113053](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656353.png)
...
8. 浏览器打开管理控制台
   ...
   ![image-20221018154823983](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656457.png)
...
6. 测试
   ...
   ![image-20221025085432335](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656997.png)
...
2. 新建文件夹
   ...
   ![image-20221025104157628](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656862.png)

   文件夹起名为：`虚拟机集群`

3. 克隆

   ![image-20221025104131303](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656549.png)

   ![image-20221025104312091](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221656073.png)

   ![image-20221025104329109](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657993.png)

   ![image-20221025104345484](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657187.png)

   ![image-20221025104414576](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657482.png)

   ![image-20221025104427160](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657500.png)

   ![image-20221025104432927](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657838.png)

   ![image-20221025104446044](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657096.png)

4. 同样的操作克隆出：node2和node3

   ![image-20221025104825204](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657957.png)
...
9. 验证Kafka启动
   ...
   ![image-20221025174522487](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657165.png)
...
![image-20221026202935745](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221657304.png)
...
![1574338996145](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658070.png)
...
![1571981197131](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658483.png)
...
![1571993951841](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658878.png)
...
![1571994069689](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658553.png)
...
![1571994111921](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658078.png)
...
![1571994206902](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658364.png)

**配置完成**

![1571994221531](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658570.png)
...
![1571994287036](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221658547.png)
...
![1573635500521](https://raw.githubusercontent.com/onetioner/img/main/PicGo3/202502221659438.png)
